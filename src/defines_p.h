...
#define __nut_FIELD_SCRIPT    "script"
...
#define __nut_INPUT_RANGE_MAX     "input_range_max"
#define __nut_INPUT_RANGE_MIN     "input_range_min"
#define __nut_INPUT_DECIMALS     "input_decimals"
